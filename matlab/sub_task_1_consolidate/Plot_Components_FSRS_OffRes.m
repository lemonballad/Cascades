...
%     dt=dts(iv);
    ...
    gc(iv)=subplot(2,3,1+3*(iv-1));contourf(FSRS_OffRes_dws,...
        FSRS_OffRes_disps,abs(rcas(:,:,iv)),50,'edgecolor','none');
    ...
    gd(iv)=subplot(2,3,2+3*(iv-1));contourf(FSRS_OffRes_dws,...
        FSRS_OffRes_disps,abs(rdir(:,:,iv)),50,'edgecolor','none');
    xlabel('(\omega_{AP}-\omega_{eg})/2\pic (cm^{-1})');
    ...
    gr(iv)=subplot(2,3,3+3*(iv-1));contourf(FSRS_OffRes_dws,...
        FSRS_OffRes_disps,(FSRS_OffRes_Ratio(:,:,iv)),50,'edgecolor','none');
    xlabel('(\omega_{AP}-\omega_{eg})/2\pic (cm^{-1})');
