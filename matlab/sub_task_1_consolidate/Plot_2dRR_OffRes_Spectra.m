...
OffRes_2dRR_Full=OffRes_2dRR_Cascade+OffRes_2dRR_Direct;
OffRes_2dRR_Cascade=OffRes_2dRR_Cascade;
OffRes_2dRR_Direct=OffRes_2dRR_Direct;
...
w=(-1/2:dw:(1/2-dw))/OffRes_2dRR_dts/c;

    maxs=max(max(abs(real(OffRes_2dRR_Full(:,:,1)))));
    subplot(1,3,1);
    contour(w,w,abs(real(OffRes_2dRR_Cascade(:,:,1)))/maxs,50);
    xlabel('\omega_1/2\pic (cm^{-1})');%xlim([0 1500]);ylim([0 1500]);
    ...
    subplot(1,3,2);
    contour(w,w,abs(real(OffRes_2dRR_Direct(:,:,1)))/maxs,50);
    xlabel('\omega_1/2\pic (cm^{-1})');%xlim([0 1500]);ylim([0 1500]);
    ylabel('\omega_2/2\pic (cm^{-1})');%caxis([0 maxr])
    ...
    subplot(1,3,3);
    contour(w,w,abs(real(OffRes_2dRR_Full(:,:,1)))/maxs,50);
    xlabel('\omega_1/2\pic (cm^{-1})');%xlim([0 1500]);ylim([0 1500]);
    ylabel('\omega_2/2\pic (cm^{-1})');%caxis([0 maxr])
