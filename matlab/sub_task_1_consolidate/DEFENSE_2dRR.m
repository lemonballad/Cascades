...
w_t=weg;
CH2Cl2_2DRR_nt=128;
CH2Cl2_2DRR_dws=-3000:50:3000;nw=length(CH2Cl2_2DRR_dws);
CH2Cl2_2DRR_Ratio=complex(zeros(nw,2,'double'));
for iv=1:2
    if iv==1
...
C_Sol=2e-4;
   ...
   for iw=1:nw
       tic
            ...
            parameters_laser.nt=CH2Cl2_2DRR_nt;
            ...
            CH2Cl2_2DRR_Ratio(iw,iv)=rat*prefactor*3e10;
            CH2Cl2_2DRR_Cas(iw,iv)=cas*prefactor*3e10;CH2Cl2_2DRR_Dir(iw,iv)=dir;
            [rat,cas,dir] = cascade_2dRR_Res(wviball_TC,2*nquanta,ovlp_TC,...
                parameters_laser,parameters_material);
            CH2Cl2_2DRR_Ratio2(iw,iv)=rat*prefactorres/3e10;
            CH2Cl2_2DRR_Cas2(iw,iv)=cas*prefactorres/3e10;CH2Cl2_2DRR_Dir2(iw,iv)=dir;
            

            toc
    end
end
save('CH2Cl2_2DRR','CH2Cl2_2DRR_Ratio','CH2Cl2_2DRR_Cas','CH2Cl2_2DRR_Dir'...
    ,'CH2Cl2_2DRR_Cas2','CH2Cl2_2DRR_Dir2');
'done'

load CH2Cl2_2DRR
figure;plot(CH2Cl2_2DRR_dws,abs(CH2Cl2_2DRR_Cas(:,1)+...
    CH2Cl2_2DRR_Cas2(:,1))./abs(CH2Cl2_2DRR_Dir(:,1)),'r-','Linewidth',2);hold on
plot(CH2Cl2_2DRR_dws,abs(CH2Cl2_2DRR_Cas(:,2)+...
    CH2Cl2_2DRR_Cas2(:,2))./abs(CH2Cl2_2DRR_Dir(:,2)),'b-','Linewidth',2);
