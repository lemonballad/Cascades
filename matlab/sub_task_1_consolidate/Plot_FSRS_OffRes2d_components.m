...
% Plot
subplot(2,1,1);contourf(FSRS_OffRes_2d_dws,FSRS_OffRes_2d_dvibs,abs(FSRS_OffRes_2d_Cas(:,:,1)),50,'edgecolor','none');
...
subplot(2,1,2);contourf(FSRS_OffRes_2d_dws,FSRS_OffRes_2d_dvibs,abs(FSRS_OffRes_2d_Cas(:,:,2)),50,'edgecolor','none');
xlabel('(\omega_L-\omega_{eg})/2\pic (cm^{-1})');
ylabel({'\omega_{vib}/2\pic (cm^{-1})'});
...
% Plot
subplot(2,1,1);contourf(FSRS_OffRes_2d_dws,FSRS_OffRes_2d_dvibs,abs(FSRS_OffRes_2d_Dir(:,:,1)),50,'edgecolor','none');
xlabel('(\omega_L-\omega_{eg})/2\pic (cm^{-1})');
ylabel({'\omega_{vib}/2\pic (cm^{-1})'});
colormap jet;colorbar('Location','northoutside','fontsize',10,'Position',cpos(1,:));
set(gca,'linewidth',2,'fontsize',10,'fontweight','bold','Position',pos(1,:));axis square;
...
subplot(2,1,2);contourf(FSRS_OffRes_2d_dws,FSRS_OffRes_2d_dvibs,abs(FSRS_OffRes_2d_Dir(:,:,2)),50,'edgecolor','none');
xlabel('(\omega_L-\omega_{eg})/2\pic (cm^{-1})');
ylabel({'\omega_{vib}/2\pic (cm^{-1})'});
colormap jet;colorbar('Location','northoutside','fontsize',10,'Position',cpos(2,:));
set(gca,'linewidth',2,'fontsize',10,'fontweight','bold','Position',pos(2,:));axis square;
