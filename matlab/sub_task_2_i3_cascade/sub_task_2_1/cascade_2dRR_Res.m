...
LcP=1./(wvib-2*w+2i*gamma_vib);%exp((-1i*wS*r2w-damp).*tau0);
...
%                                     *Lp(v,l);
    ...
    f1P=sum(f1P);f2P=sum(f2P);f3P=sum(f3P);f4P=sum(f4P);
...
seq1=(f1+f2+f3+f4)*(f1+f2+f3+f4);%7.9e-4*
seq2=(f1C+f2C+f3C+f4C)*(f1+f2+f3+f4);%2.7e-3*
par1=(f1P+f2P+f3P+f4P)...
    *(f1+f2+f3+f4);%8e-4*
par2=(f1+f2+f3+f4)...
    *(f1P+f2P+f3P+f4P);%0.09*
