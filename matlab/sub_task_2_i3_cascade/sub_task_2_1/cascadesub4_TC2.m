function [seq,par,cascade2d,direct2d,cascade,direct] = cascadesub4_TC(E_vib,nquanta,ovlp,...
...
%                         % cascade                      
%                         f1_1(it2,:)=f1_1(it2,:)+boltz_pop(m)*ovlp(n,m)*ovlp(n,k)*ovlp(l,k)*ovlp(l,m)...
%                             *1/(w_L-weg-w(n,m)+1i*gamma_eg)...
%                             .*exp(-1i*w(k,m)*r2w*tau_1-*gamma_vib*c*tau_1)...
%                             *1/(w_L-weg-w(l,m)+1i*gamma_eg);
%                         f1_2(it2,:)=f1_2(it2,:)+boltz_pop(m)*ovlp(n,m)*ovlp(n,k)*ovlp(l,k)*ovlp(l,m)...
%                             *1/(w_L-weg-w(n,m)+1i*gamma_eg)...
%                             .*exp(-1i*w(k,m)*r2w*tau_2(it2)-*gamma_vib*c*tau_2(it2))...
%                             *1/(w_L-weg-w(l,m)+1i*gamma_eg);
%                         f1_p(it2,:)=f1_p(it2,:)+boltz_pop(m)*ovlp(n,m)*ovlp(n,k)*ovlp(l,k)*ovlp(l,m)...
%                             *1/(w_L-weg-w(n,m)+1i*gamma_eg)...
%                             .*exp(-1i*w(k,m)*r2w*(tau_1+tau_2(it2))-*gamma_vib*c*(tau_1+tau_2(it2)))...
%                             *1/(w_L-weg-w(l,m)+1i*gamma_eg);
% 
%                         % Auxillary function #2 for third order
%                         % cascade
%                         f2_1(it2,:)=f2_1(it2,:)+boltz_pop(m)*ovlp(n,m)*ovlp(n,k)*ovlp(l,m)*ovlp(l,k)...
%                             *1/(-w_L+weg-w(m,n)+1i*gamma_eg)...
%                             .*exp(-1i*w(m,k)*r2w*tau_1-*gamma_vib*c*tau_1)...
%                             *1/(w_L-weg-w(l,k)+1i*gamma_eg);
%                         f2_2(it2,:)=f2_2(it2,:)+boltz_pop(m)*ovlp(n,m)*ovlp(n,k)*ovlp(l,m)*ovlp(l,k)...
%                             *1/(-w_L+weg-w(m,n)+1i*gamma_eg)...
%                             .*exp(-1i*w(m,k)*r2w*tau_2(it2)-*gamma_vib*c*tau_2(it2))...
%                             *1/(w_L-weg-w(l,k)+1i*gamma_eg);
%                         f2_p(it2,:)=f2_p(it2,:)+boltz_pop(m)*ovlp(n,m)*ovlp(n,k)*ovlp(l,m)*ovlp(l,k)...
%                             *1/(-w_L+weg-w(m,n)+1i*gamma_eg)...
%                             .*exp(-1i*w(m,k)*r2w*(tau_1+tau_2(it2))-*gamma_vib*c*(tau_1+tau_2(it2)))...
%                             *1/(w_L-weg-w(l,k)+1i*gamma_eg);
%                     end
%                     if k~=n
%                         % Auxillary function #3 for third order
%                         % cascade
%                         f3_1(it2,:)=f3_1(it2,:)+boltz_pop(m)*ovlp(n,m)*ovlp(k,m)*ovlp(k,l)*ovlp(n,l)...
%                             *1./(w_L-weg-w(n,m)+1i*gamma_eg)...
%                             .*exp(-1i*w(n,k)*r2w*tau_1-gamma_vib*c*tau_1)...
%                             *1./(w_L-weg-w(n,l)+1i*gamma_eg);
%                         f3_2(it2,:)=f3_2(it2,:)+boltz_pop(m)*ovlp(n,m)*ovlp(k,m)*ovlp(k,l)*ovlp(n,l)...
%                             *1./(w_L-weg-w(n,m)+1i*gamma_eg)...
%                             .*exp(-1i*w(n,k)*r2w*tau_2(it2)-gamma_vib*c*tau_2(it2))...
%                             *1./(w_L-weg-w(n,l)+1i*gamma_eg);
%                         f3_p(it2,:)=f3_p(it2,:)+boltz_pop(m)*ovlp(n,m)*ovlp(k,m)*ovlp(k,l)*ovlp(n,l)...
%                             *1./(w_L-weg-w(n,m)+1i*gamma_eg)...
%                             .*exp(-1i*w(n,k)*r2w*(tau_1+tau_2(it2))-gamma_vib*c*(tau_1+tau_2(it2)))...
%                             *1./(w_L-weg-w(n,l)+1i*gamma_eg);
% 
%                         % Auxillary function #4 for third order
%                         % cascade
%                         f4_1(it2,:)=f4_1(it2,:)+boltz_pop(m)*ovlp(n,m)*ovlp(k,m)*ovlp(n,l)*ovlp(k,l)...
%                             *1./(-w_L+weg-w(m,n)+1i*gamma_eg)...
%                             .*exp(-1i*w(k,n)*r2w*tau_1-gamma_vib*c*tau_1)...
%                             *1./(w_L-weg-w(k,l)+1i*gamma_eg);
%                         f4_1(it2,:)=f4_1(it2,:)+boltz_pop(m)*ovlp(n,m)*ovlp(k,m)*ovlp(n,l)*ovlp(k,l)...
%                             *1./(-w_L+weg-w(m,n)+1i*gamma_eg)...
%                             .*exp(-1i*w(k,n)*r2w*tau_2(it2)-gamma_vib*c*tau_2(it2))...
%                             *1./(w_L-weg-w(k,l)+1i*gamma_eg);
%                         f4_1(it2,:)=f4_1(it2,:)+boltz_pop(m)*ovlp(n,m)*ovlp(k,m)*ovlp(n,l)*ovlp(k,l)...
%                             *1./(-w_L+weg-w(m,n)+1i*gamma_eg)...
%                             .*exp(-1i*w(k,n)*r2w*(tau_1+tau_2(it2))-gamma_vib*c*(tau_1+tau_2(it2)))...
%                             *1./(w_L-weg-w(k,l)+1i*gamma_eg);
...
cascade=seq1(1:nt1,1:nt1)+seq2(1:nt1,1:nt1)+par1+par2;
