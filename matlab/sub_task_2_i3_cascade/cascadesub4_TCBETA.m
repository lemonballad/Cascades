...
%                             r0=r0+boltz_pop(m)*ovlp(n,m)*ovlp(n,k)*ovlp(l,k)*ovlp(l,u)*ovlp(v,u)*ovlp(v,m)...
%                                 *1/(w_L-weg-w(n,m)+1i*gamma_eg)...
%                                 *1/(wvib--w(k,m)+1i*gamma_vib)...
%                                 *1./(w_L-weg-w(l,m)+1i*gamma_eg)...
%                                 *1/(wvib--w(u,m)+1i*gamma_vib)...
