...
%                 [toc]% nl]
                tic
                [directk(id,iw,iv,:,:),cascade_3k(id,iw,iv,:,:),~,~,~] = FSRS_TC_Tuning_KAPPA(wviball_TC,fcall_TC,...
...
%                 
rTCk(id,iw)=prefactor(id,iw,iv)*abs(cascade_3k(id,iw,iv,1))./abs(directk(id,iw,iv,1))/3e10;
