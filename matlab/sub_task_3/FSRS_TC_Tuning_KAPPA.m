function [ratio,cas,dir] = FSRS_TC_Tuning(E_vib,ovlp,nquanta,...
...
cas=-1i^3*(f1A+f2A+f3A+f4A)...
    .*(f1B+f2B+f3B+f4B);%*exp(2i*(w_rp-w_t)*tau2*r2w);
...
direct=(r1+r2+r3+r4)...
    +(r5+r6+r7+r8)...
    +(r9+r10+r11+r12)...
    +(r13+r14+r15+r16);%*exp(1i*(w_rp-w_t)*tau2*r2w);
% direct=(r1+r2+r3+r4);
dir=-direct;
